// Central Font Awesome icon registry so every icon is imported once.
import { faBookQuran } from '@fortawesome/free-solid-svg-icons/faBookQuran'
...
import { faHandsHoldingChild } from '@fortawesome/free-solid-svg-icons/faHandsHoldingChild'
